...
- **Auto-ignore**: Major version updates for `@modelcontextprotocol/sdk` to prevent breaking changes
...
3. **Assignment**: PRs are automatically assigned to `dynatrace-oss/dynatrace-managed-mcp-maintainers`
